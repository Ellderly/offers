...
<!-- Google tag (gtag.js) -->
  ...
  <img height="1" width="1" src="https://www.facebook.com/tr?id=<?=$_GET['fbp']?>&ev=Lead&noscript=1"/>
      ...
      <div class="container">
        <div class="general">
          ...
          <div class="general-text">
            ...
            <p class="sub-title">С Вами свяжется менеджер и поможет начать путь к успешным инвестициям</p>
