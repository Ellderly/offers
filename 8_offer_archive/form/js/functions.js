...
export function thenkYouPage(autologLink, company) {
	const domain = window.location.hostname
	const nameCompany = getParramUtm('nameCompany')
	if (autologLink) {
		window.location.href = `thanks.php${window.location.search}&autologin=${autologLink}`
	} else {
		window.location.href = `thanks.php${window.location.search}`
	}
}
...
export function renderFormRegistrations(allFormClass) {
 ...
 <div class="form-group input-group input-group--name">
  ...
  <div class="form-group input-group input-group--name">
    ...
    <input class="form-control  form-input input is-large" name="lastname" placeholder="Фамилия *"  type="text" />
    <i class="fa__err"></i>
    <span class="fa__errInfo">- Введите в указанном формате<br> - Имя и фамилия не должны совпадать</span>
    <i class="fa__checked"></i> 
  ...
  <input type="hidden" name="answer">
    ...
    <div class="lead-form__agreement">
                        <label class="b-checkbox checkbox">
                          <input name="cb1" type="checkbox" true-value="true" required="">

                          <span class="check"></span>
                          <span class="control-label">
                            <span>
                              <p>
                                Являюсь гражданином ЕС<br>
                                (программа не принимает жителей Украины)
                              </p>
                            </span>
                          </span>
                        </label>
  ...
  <div class="form-group">
    ...
    <button class="btn btn-block button lead-form__button is-outline buttonSend lead-form__button"  name="submitBtn" type="submit">
    <span class="icon">
    ...
    <span>Получить бесплатный доступ</span>
    </button>
  </div>
