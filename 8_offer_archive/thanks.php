...
<html lang="en">
  <head>
    ...
    <title>Спасибо за регистрацию!</title>
      ...
      <?php $pxl = $_GET["fbp"] ?? ($_GET["pixel"] ?? 'Unknown'); ?>
...
<!-- Google tag (gtag.js) -->
      ...
      <?php $camp = $_GET['camp_id'] ?? null; ?>
      <?php if ($camp) { ?>
          <script async src="https://www.googletagmanager.com/gtag/js?id=AW-<?= htmlspecialchars($camp); ?>"></script>
          <script>
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
              gtag('config', 'AW-<?= htmlspecialchars($camp); ?>');
          </script>
          ...
          <script>
              ...
              gtag('event', 'conversion', {
                  ...
                  'send_to': 'AW-<?php echo htmlspecialchars($camp); ?>/<?php echo htmlspecialchars($_GET["gpixel2"]) ?>',
  ...
  <div class="contentAlert">
    ...
    <div class="bottomHalf">
      ...
      Спасибо за регистрацию! <br />
       Ждите звонка наших специалистов!
      </h2>
